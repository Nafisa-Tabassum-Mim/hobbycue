...
const Footer = () => {
    return (
        <div>
            <div className="px-12 mt-12 pt-8 ">
                <h3 className="italic text-xl md:text-4xl font-bold pb-2 md:pb-8">Your <span className="text-customPurple">Hobby</span>, Your <span className="text-customBlue">Community...</span></h3>

                <button type="submit" className=" text-center bg-customPurple text-white rounded-md px-4 py-[4px] mb-8">Get Started</button>
                <img src="https://i.ibb.co/80WqnMn/Group-99.png" alt="" />
            </div>
            <div>
                <footer className="flex flex-col md:flex-row justify-evenly p-10 md:mt-12 bg-base-200 text-base-content">
                    <div className="text-sm">
                        <h6 className="font-bold"><button>Hobbycue</button></h6>
                        ...
                        <div>
                            ...
                            <div className="" id="navbarSupportedContent">
                                <form className="d-flex " role="search">
                                    ...
                                    <button className="px-[10px] rounded-r-lg text-white bg-customPurple" type="submit">Invite</button>
                                </form>
                            </div>
                        </div>
                    </div>
                ...
                <div>
                    <p className="font-bold text-center text-xs bg-[#F7F5F9] py-6">© Purple Cues Private Limited</p>
                </div>
            </div>
        </div>
    );
